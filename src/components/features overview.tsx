...
const AppFeaturesOverview: React.FC = () => {
  return (
    <section id="features-overview" className="bg-[#181C2E] py-16 md:py-[135px] md:px-0 md:pr-12">
      {/* Title */}
      ...
      <div className="max-w-sm md:max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-8 items-center">
          ...
          <div className="flex justify-start lg:justify-start order-1 md:order-1">
            <div className="relative flex items-end">
              {/* Circular Glow */}
              <div className="absolute left-1/2 bottom-4 md:-bottom-10 -translate-x-1/2 w-[320px] h-[420px] md:w-[700px] md:h-[700px] rounded-full pointer-events-none z-0"
                style={{ background: 'radial-gradient(ellipse at center, rgba(58,141,255,0.18) 0%, rgba(58,141,255,0.06) 80%, rgba(58,141,255,0) 100%)', filter: 'blur(38px)' }}
              />
              <img src={featuresOverviewPhonesMockup} className="w-full max-w-[360px] md:max-w-[689px] h-auto md:h-[550px] relative z-10 mt-8" />
            </div>
          </div>

          {/* Right Side - Feature Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 px-3 md:px-0 gap-5 md:gap-4 order-2 md:order-2">

            {/* Real-Time Stack Score */}
            <div className="bg-[#2A2F43] rounded-[18px] py-6 px-4 md:py-6 md:px-3 transition-colors duration-300 group hover:bg-[#3A8DFF] flex flex-col h-full">
              <div>
                ...
                <h3 className="text-white text-[20px] md:text-[24px] font-bold font-montserrat text-center mb-3">
                  Real-Time Stack Score
                </h3>
              </div>
              <div className="flex-grow"></div>
              <p className="text-[#F4F6FA] text-[16px] font-montserrat text-center leading-relaxed mb-0">
            ...
            <div className="bg-[#2A2F43] rounded-[18px] py-6 px-4 md:py-6 md:px-3 transition-colors duration-300 group hover:bg-[#3A8DFF] flex flex-col h-full">
              <div>
                ...
                <h3 className="text-white text-[20px] md:text-[20px] font-bold font-montserrat text-center mb-3">
                  Health & Performance Tracking
                </h3>
              </div>
              <div className="flex-grow"></div>
