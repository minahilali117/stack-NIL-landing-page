  ...
  return (
    <section className="bg-[#181C2E] md:pb-16 px-4 md:px-16 overflow-x-hidden">
      ...
      <div className="max-w-sm md:max-w-7xl mx-auto relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-9 items-stretch">
          
          <div className="relative">
            <div className="bg-[#3A8DFF29] rounded-[18px] md:rounded-[20px] px-4 pt-7 pb-4 md:pt-10 md:pb-8 md:px-4 border-2 border-transparent hover:border-[#3A8DFF] transition-all duration-700 h-full flex flex-col">
              <div className="mb-8 md:mb-10 flex justify-center">
                <img src={aiAgentAlwaysAvailableToChat} className="w-[127px] h-[127px] md:w-[140px] md:h-[140px]" />
              </div>
              <div className="text-center flex-1 flex flex-col">
                    <h3 className="text-white text-[22px] md:text-[24px] font-bold font-montserrat mb-3">
                  Your AI Agent is always available to chat
                </h3>
                <p className="text-[#F4F6FA] text-[16px] md:text-[18px] font-montserrat leading-relaxed mb-2 flex-1">
            ...
            <div className="md:hidden block absolute -bottom-10 right-5 z-10">
              <img src={curlyBottomArrowBlue} className="w-[134px] h-16 -scale-x-100 -rotate-[15deg]" />
            </div>
          </div>

          <div className="relative">
            <div className="bg-[#00FFAB29] rounded-[18px] md:rounded-[20px] px-4 pt-7 pb-4 md:pt-10 md:pb-8 md:px-4 border-2 border-transparent hover:border-[#00FFAB] transition-all duration-700 h-full flex flex-col">
              <div className="mb-8 md:mb-10 flex justify-center">
                <img src={nilMatchmaking} className="w-[127px] h-[127px] md:w-[140px] md:h-[140px]" />
              </div>
              <div className="text-center flex-1 flex flex-col">
                    <h3 className="text-white text-[22px] md:text-[24px] font-bold font-montserrat mb-3">
                  NIL Matchmaking Services
                </h3>
                <p className="text-[#F4F6FA] text-[16px] md:text-[17px] font-montserrat leading-relaxed mb-2 flex-1">
          ...
          <div className="relative">
            <div className="bg-[#A259FF29] rounded-[18px] md:rounded-[20px] px-4 pt-7 pb-4 md:pt-8 md:pb-7 md:px-5 border-2 border-transparent hover:border-[#A259FF] transition-all duration-700 h-full flex flex-col">
              <div className="mb-6 flex justify-center">
                  <img src={contentCreation} className="w-[160px] h-[160px] md:w-[176px] md:h-[176px]" />
              </div>
              <div className="text-center flex-1 flex flex-col">
                    <h3 className="text-white text-[22px] md:text-[24px] font-bold font-montserrat mb-3">
                ...
                <div className="flex justify-center">
                  <button className="bg-transparent hover:border-[#A259FF] md:h-[50px] md:w-[165px] text-[15px] md:text-[16px] border-1 border-[#F4F6FA] text-[#F4F6FA] px-6 py-3 rounded-lg font-montserrat font-bold transition-colors duration-300">
                    LEARN MORE
                  </button>
                </div>
              </div>
